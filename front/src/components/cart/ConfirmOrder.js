        ...
        <Fragment>
            ...
            <div className="row d-flex justify-content-between">
                <div className="col-12 col-lg-8 mt-5 order-confirm">
                    ...
                    <hr />
                    <h4 className="mt-4">Products loaded in your shopping cart:</h4>
                    {cartItems.map(item => (
                        <Fragment>
                            <hr />
                ...
                <div className="col-12 col-lg-3 my-4">
                    <div id="order_summary">
                        ...
                        <hr />
                        <button id="checkout_btn" className="btn btn-primary btn-block" onClick={processToPayment}>Proceed with the payment</button>
                    </div>
                </div>
            </div>
        </Fragment>
